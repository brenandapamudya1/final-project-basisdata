...
-- 1. TOKO
INSERT INTO toko (id_toko, nama_toko, alamat, kota, telp, jam_buka, jam_tutup, is_24_jam, status) VALUES
  ('TE001','Express Darmo', 'Jl. Darmo No. 10', 'Surabaya','031-11111111','06:00:00','23:00:00','Tidak','aktif'),
  ('TE002','Express Gubeng','Jl. Gubeng No. 5',  'Surabaya','031-22222222','00:00:00','23:59:59','Ya',   'aktif');
...
-- 2. DIVISI
INSERT INTO divisi (id_divisi, nama_divisi, deskripsi, level_jabatan) VALUES
  ('DV0001','Kasir',       'Melayani transaksi pembayaran',           'staff'),
  ('DV0002','Pramuniaga',  'Display barang dan pelayanan pelanggan',  'staff'),
  ('DV0003','Staff Gudang','Penerimaan dan pengelolaan stok toko',    'staff'),
  ('DV0004', 'Supervisor Toko', 'Mengelola Operasional Harian', 'supervisor'),
  ('DV0005','Head Store',  'Supervisi operasional dan approval harga','manager');
...
INSERT INTO pegawai (id_pegawai, nama, nik, no_hp, alamat, id_toko, tgl_masuk, status) VALUES
  ('PE0001','Budi Santoso', '3578011234001','08111111111','Jl. A No.1 Surabaya','TE001','2022-01-10','aktif'),
  ('PE0002','Siti Rahayu',  '3578012345002','08222222222','Jl. B No.2 Surabaya','TE001','2022-03-15','aktif'),
  ('PE0003','Andi Wijaya',  '3578013456003','08333333333','Jl. C No.3 Surabaya','TE002','2021-07-01','aktif'),
  ('PE0004','Dewi Puspita', '3578014567004','08444444444','Jl. D No.4 Surabaya','TE002','2023-01-05','aktif'),
  ('PE0005','Rian Hidayat', '3578015678005','08555555555','Jl. E No.5 Surabaya','TE001','2023-08-20','aktif'),
  ('PE0006','Nina Oktavia', '3578016789006','08666666666','Jl. F No.6 Surabaya','TE002','2024-02-11','aktif');
...
INSERT INTO pegawai_divisi (id_pegawai, id_divisi, tgl_mulai, tgl_selesai, is_primary) VALUES
  ('PE0001','DV0001','2022-01-10', NULL,'Ya'),
  ('PE0001','DV0002','2023-06-01', NULL,'Tidak'),   -- kasir rangkap pramuniaga
  ('PE0002','DV0004','2022-03-15', NULL,'Ya'),
  ('PE0002','DV0001','2023-09-01', NULL,'Tidak'),   -- pramuniaga rangkap kasir
  ('PE0003','DV0001','2021-07-01', NULL,'Ya'),
  ('PE0003','DV0005','2022-07-01', NULL,'Tidak'),   -- kasir senior rangkap head store
  ('PE0004','DV0002','2023-01-05', NULL,'Ya'),
  ('PE0005','DV0003','2023-08-20', NULL,'Ya'),
  ('PE0005','DV0002','2024-03-01', NULL,'Tidak'),   -- staff gudang bantu pramu
  ('PE0006','DV0001','2024-02-11', NULL,'Ya');
...
INSERT INTO absensi (id_pegawai, tanggal, jam_masuk, jam_keluar, status, keterangan) VALUES
  ('PE0001','2026-06-01','07:55:00','17:00:00','hadir', NULL),
  ('PE0002','2026-06-01','08:05:00','17:00:00','hadir', NULL),
  ('PE0003','2026-06-01','08:00:00','17:00:00','hadir', NULL),
  ('PE0004','2026-06-01','08:10:00','17:00:00','hadir', NULL),
  ('PE0005','2026-06-01','07:30:00','16:30:00','hadir', NULL),
  ('PE0006','2026-06-01','22:00:00','06:00:00','hadir', 'Shift malam'),
  ('PE0001','2026-06-02','08:00:00','17:00:00','hadir', NULL),
  ('PE0002','2026-06-02',NULL,       NULL,      'izin',  'Keperluan keluarga'),
  ('PE0003','2026-06-02','08:00:00','17:00:00','hadir', NULL),
  ('PE0005','2026-06-02','07:30:00','16:30:00','hadir', NULL),
  ('PE0006','2026-06-02', NULL,      NULL,      'sakit', 'Demam');
...
CREATE TABLE supplier (
    ...
    top_hari      TINYINT UNSIGNED DEFAULT 14,   -- TOP lebih singkat: express restock harian
    is_aktif      ENUM('Ya','Tidak') NOT NULL DEFAULT 'Ya'
);

-- 7. SUPPLIER (referensi lokal toko, sinkron dari gudang_db)
...
INSERT INTO barang (id_barang, nama_barang, id_kategori, id_supplier, satuan, berat_gram, is_aktif) VALUES
  ('BE000001','Sampoerna Mild 16s', 'KT0001','SP0001','bungkus', 22.0, 'Ya'),
  ('BE000002','Gudang Garam 12s',   'KT0001','SP0001','bungkus', 18.0, 'Ya'),
  ('BE000003','Aqua Botol 600ml',   'KT0002','SP0002','botol',  600.0, 'Ya'),
  ('BE000004','Teh Botol 350ml',    'KT0003','SP0002','botol',  350.0, 'Ya'),
  ('BE000005','Pocari Sweat 500ml', 'KT0003','SP0002','botol',  500.0, 'Ya'),
  ('BE000006','Chitato 68g',        'KT0004','SP0003','pcs',     68.0, 'Ya'),
  ('BE000007','Oreo 137g',          'KT0004','SP0003','pcs',    137.0, 'Ya'),
  ('BE000008','Indomie Goreng',     'KT0005','SP0003','pcs',     85.0, 'Ya'),
  ('BE000009','Roti Tawar Sari',    'KT0006','SP0004','pcs',    400.0, 'Ya');
...
INSERT INTO harga_barang
  (id_barang, id_toko, harga_beli, harga_jual, tgl_berlaku, tgl_berakhir, status, diinput_oleh, disetujui_oleh, tgl_approval, catatan) VALUES
  ('BE000001','TE001',13000,26000,'2026-06-01',NULL,'approved','PE0001','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000001','TE002',13000,26000,'2026-06-01',NULL,'approved','PE0003','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000003','TE001', 3000, 5000,'2026-06-01',NULL,'approved','PE0001','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000004','TE001', 5500, 8000,'2026-06-01',NULL,'approved','PE0001','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000006','TE001', 8000,10000,'2026-06-01',NULL,'approved','PE0001','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000008','TE001', 5000,13000,'2026-06-01',NULL,'approved','PE0001','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000003','TE002', 3000, 5000,'2026-06-01',NULL,'approved','PE0003','PE0003','2026-06-01 07:30:00', NULL),
  ('BE000006','TE002', 8000,10000,'2026-06-01',NULL,'approved','PE0003','PE0003','2026-06-01 07:30:00', NULL),
  -- barang harga fluktuatif, baru masuk, masih menunggu approval Head Store
  ('BE000002','TE002',10000,20000,'2026-06-10',NULL,'pending', 'PE0004',NULL,    NULL,                  'Harga naik dari supplier, menunggu approval'),
  ('BE000009','TE001', 7000,12000,'2026-06-12',NULL,'pending', 'PE0005',NULL,    NULL,                  'Produk baru, belum direview Head Store');	
...
INSERT INTO display_barang (id_barang, id_toko, id_harga, status_barang, tgl_display, tgl_tarik, diupdate_oleh) VALUES
  ('BE000001','TE001',1,'displayed','2026-06-01',NULL,'PE0002'),
  ('BE000001','TE002',2,'displayed','2026-06-01',NULL,'PE0004'),
  ('BE000003','TE001',3,'displayed','2026-06-01',NULL,'PE0002'),
  ('BE000004','TE001',4,'displayed','2026-06-01',NULL,'PE0002'),
  ('BE000006','TE001',5,'displayed','2026-06-01',NULL,'PE0002'),
  ('BE000008','TE001',6,'displayed','2026-06-01',NULL,'PE0002'),
  ('BE000003','TE002',7,'displayed','2026-06-01',NULL,'PE0004'),
  ('BE000006','TE002',8,'displayed','2026-06-01',NULL,'PE0004'),
...
-- 11. STOK TOKO
INSERT INTO stok_toko (id_barang, id_toko, jumlah, stok_minimal) VALUES
  ('BE000001','TE001', 80, 20),
...
-- 14. CUSTOMER
INSERT INTO customer (id_customer, nama, no_hp, email, tgl_daftar, poin_loyalty) VALUES
  ('CE0001','Umum',         NULL,           NULL,                '2026-01-01',  0),
  ('CE0002','Budi Hartono', '081200001001', 'budi@example.com',  '2026-01-10',150),
  ('CE0003','Sari Dewi',    '081200001002', 'sari@example.com',  '2026-03-22',320),
  ('CE0004','Rudi Saputra', '081200001003', 'rudi@example.com',  '2026-05-02', 45);
...
-- 15. PROMO
INSERT INTO promo (id_promo, nama_promo, id_barang, jenis_diskon, nilai_diskon, tgl_mulai, tgl_selesai, is_aktif) VALUES
  ('PR0001','Diskon Aqua 10%',    'BE000003','persen', 10,  '2026-06-01','2026-06-30','Ya'),
  ('PR0002','Diskon Chitato 5rb', 'BE000006','nominal',5000,'2026-06-01','2026-06-15','Ya'),
  ('PR0003','Promo Teh Botol',    'BE000004','persen', 5,   '2026-05-01','2026-05-31','Tidak');   -- promo lama, sudah nonaktif
...
INSERT INTO metode_pembayaran (id_metode, nama_metode, keterangan) VALUES
  ('PY01','tunai',      'Pembayaran tunai di kasir'),
  ('PY02','qris',       'Pembayaran QRIS'),
  ('PY03','debit',      'Pembayaran kartu debit'),
  ('PY04','transfer',   'Transfer bank, biasa untuk reseller'),
  ('PY05','tarik_tunai','Tarik tunai di kasir, biaya admin berlaku');
...
INSERT INTO transaksi_penjualan (id_toko, id_customer, id_pegawai, tgl_transaksi, total_belanja, total_diskon, total_bayar, status) VALUES
  ('TE001','CE0001','PE0001','2026-06-01 09:15:00',31000,    0,31000,'selesai'),
  ('TE001','CE0002','PE0001','2026-06-01 10:30:00',31000, 2600,28400,'selesai'),
  ('TE001','CE0001','PE0002','2026-06-01 14:00:00',13000,    0,13000,'selesai'),
  ('TE002','CE0003','PE0003','2026-06-02 08:45:00',36000, 5000,31000,'selesai'),
  ('TE002','CE0004','PE0006','2026-06-02 23:10:00',26000,    0,26000,'selesai'),
  ('TE001','CE0001','PE0001','2026-06-02 17:30:00', 8000,    0, 8000,'batal');     -- contoh transaksi batal
...
-- 18. DETAIL TRANSAKSI
INSERT INTO detail_transaksi (id_transaksi, id_barang, id_promo, jumlah, harga_satuan, diskon, subtotal) VALUES
  (1,'BE000001',NULL,    1,26000,   0,26000),
  (1,'BE000003',NULL,    1, 5000,   0, 5000),
  (2,'BE000003','PR0001',2, 5000,2600, 7400),
  (2,'BE000001',NULL,    1,26000,   0,26000),
  (3,'BE000004',NULL,    1, 8000,   0, 8000),
  (3,'BE000003',NULL,    1, 5000,   0, 5000),
  (4,'BE000006','PR0002',2,10000,5000,15000),
  (4,'BE000001',NULL,    1,26000,   0,26000),
  (5,'BE000001',NULL,    1,26000,   0,26000),
  (6,'BE000004',NULL,    1, 8000,   0, 8000);
...
-- 19. PEMBAYARAN
INSERT INTO pembayaran (id_transaksi, id_metode, jumlah_bayar, no_referensi, tgl_bayar) VALUES
  (1,'PY01',31000,NULL,            '2026-06-01 09:15:00'),
  (2,'PY02',28400,'QR20260601001', '2026-06-01 10:30:00'),
  (3,'PY03',13000,'DB20260601007', '2026-06-01 14:00:00'),
  (4,'PY01',31000,NULL,            '2026-06-02 08:45:00'),
  (5,'PY02',26000,'QR20260602014', '2026-06-02 23:10:00');
-- nambah