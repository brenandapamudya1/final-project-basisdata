...
INSERT INTO toko (id_toko, nama_toko, alamat, kota, telp, jam_buka, jam_tutup, status) VALUES
('TR001','Swalayan Sentosa Rungkut','Jl. Rungkut Industri No.8','Surabaya','031-5913001','08:00:00','21:00:00','aktif'),
('TR002','Swalayan Sentosa Dukuh Kupang','Jl. Dukuh Kupang No.20','Surabaya','031-5913002','08:00:00','21:00:00','aktif');
 
INSERT INTO divisi (id_divisi, nama_divisi, deskripsi, level_jabatan) VALUES
('DR0001','Kasir','Melayani transaksi pembayaran pelanggan','staff'),
('DR0002','Cleaning Service','Menjaga kebersihan area toko','staff'),
('DR0003','Pengendali Stok','Mengelola & mengontrol stok barang gudang toko','staff'),
('DR0004','Security','Menjaga keamanan toko','staff'),
('DR0005','Pegawai Section','Bertugas pada section tertentu (Sembako/Fresh/Frozen/Household)','staff'),
('DR0006','Store Supervisor','Mengawasi operasional harian gerai','supervisor'),
('DR0007','Head Store','Manager/kepala toko per gerai','manager');
 
INSERT INTO pegawai (id_pegawai, nama, nik, no_hp, alamat, id_toko, section, tgl_masuk, status) VALUES
('PR0001','Surya Hartono','3578020001','081234570001','Jl. Kenanga 1, Surabaya','TR001',NULL,'2022-05-01','aktif'),
('PR0002','Maya Anggraini','3578020002','081234570002','Jl. Kenanga 2, Surabaya','TR001',NULL,'2023-01-12','aktif'),
('PR0003','Tono Hermawan','3578020003','081234570003','Jl. Kenanga 3, Surabaya','TR001','Sembako','2023-02-20','aktif'),
('PR0004','Wulan Sari','3578020004','081234570004','Jl. Kenanga 4, Surabaya','TR001','Frozen','2023-03-15','aktif'),
('PR0005','Joko Prasetyo','3578020005','081234570005','Jl. Kenanga 5, Surabaya','TR001',NULL,'2022-08-08','aktif'),
('PR0006','Indah Permata','3578020006','081234570006','Jl. Kenanga 6, Surabaya','TR002',NULL,'2022-06-01','aktif'),
('PR0007','Agus Salim','3578020007','081234570007','Jl. Kenanga 7, Surabaya','TR002','Fresh','2023-04-01','aktif'),
('PR0008','Nita Kusuma','3578020008','081234570008','Jl. Kenanga 8, Surabaya','TR002','Household','2023-05-10','aktif');
 
INSERT INTO pegawai_divisi (id_pegawai, id_divisi, tgl_mulai, tgl_selesai, is_primary) VALUES
('PR0001','DR0007','2022-05-01', NULL, 'Ya'),                  -- Head Store TR001
('PR0002','DR0001','2023-01-12', NULL, 'Ya'),                  -- Kasir
('PR0003','DR0005','2023-02-20', NULL, 'Ya'),                  -- Pegawai Section Sembako
('PR0003','DR0001','2024-02-01', NULL, 'Tidak'),                -- rangkap bantu kasir saat ramai
('PR0004','DR0005','2023-03-15', NULL, 'Ya'),                  -- Pegawai Section Frozen
('PR0005','DR0003','2022-08-08', NULL, 'Ya'),                  -- Pengendali Stok
('PR0005','DR0005','2024-05-01', NULL, 'Tidak'),                -- bantu Pegawai Section saat stok longgar
('PR0006','DR0007','2022-06-01', NULL, 'Ya'),                  -- Head Store TR002
('PR0007','DR0005','2023-04-01', NULL, 'Ya'),                  -- Pegawai Section Fresh
('PR0008','DR0005','2023-05-10', NULL, 'Ya');                  -- Pegawai Section Household
 
INSERT INTO absensi (id_pegawai, tanggal, jam_masuk, jam_keluar, status, keterangan) VALUES
('PR0002','2026-06-15','07:55:00','17:00:00','hadir',NULL),
('PR0003','2026-06-15','08:00:00','17:00:00','hadir',NULL),
('PR0004','2026-06-15',NULL,NULL,'sakit','Demam'),
('PR0007','2026-06-15','07:58:00','17:05:00','hadir',NULL);
...
('BG000002','Minyak Goreng 1L','KR0001','SR0001','botol',1000.00,'Ya'),
('BG000003','Bayam Segar','KR0002','SR0002','ikat',250.00,'Ya'),
('BG000004','Tomat Segar','KR0002','SR0002','kg',1000.00,'Ya'),
('BG000005','Nugget Ayam Frozen','KR0003','SR0003','pack',500.00,'Ya'),
('BG000006','Es Krim Cup','KR0003','SR0003','pcs',100.00,'Ya'),
('BG000007','Susu UHT 1L','KR0004','SR0004','karton',1030.00,'Ya'),
('BG000008','Keju Slice','KR0004','SR0004','pack',200.00,'Ya'),
('BG000009','Deterjen Bubuk 1kg','KR0005','SR0005','pack',1000.00,'Ya'),
('BG000010','Sabun Mandi Batang','KR0005','SR0005','pcs',90.00,'Ya');
...
('BG000001','TR001',58000,65000,'2026-01-01',NULL,'approved','PR0003','PR0001','2026-01-01 09:00:00',NULL),
('BG000002','TR001',16000,19500,'2026-01-01',NULL,'approved','PR0003','PR0001','2026-01-01 09:05:00',NULL),
('BG000003','TR001',3000,5000,'2026-01-01',NULL,'approved','PR0007','PR0001','2026-01-01 09:10:00',NULL),
('BG000005','TR001',18000,25000,'2026-06-01',NULL,'pending','PR0004',NULL,NULL,'Menunggu approval Head Store'),
('BG000007','TR002',13000,16500,'2026-01-01',NULL,'approved','PR0007','PR0006','2026-01-01 09:15:00',NULL),
('BG000009','TR002',20000,27000,'2026-01-01',NULL,'approved','PR0008','PR0006','2026-01-01 09:20:00',NULL);
 
INSERT INTO display_barang (id_barang, id_toko, id_harga, status_barang, tgl_display, tgl_tarik, diupdate_oleh) VALUES
('BG000001','TR001',1,'displayed','2026-01-02',NULL,'PR0003'),
('BG000002','TR001',2,'displayed','2026-01-02',NULL,'PR0003'),
('BG000003','TR001',3,'displayed','2026-01-02',NULL,'PR0007'),
('BG000007','TR002',5,'displayed','2026-01-02',NULL,'PR0007'),
('BG000009','TR002',6,'displayed','2026-01-02',NULL,'PR0008');
...
('CR0001','Siti Aminah','081322220001','siti.a@example.com','2025-08-01',300),
('CR0002','Hendro Wibowo','081322220002','hendro@example.com','2025-11-20',75);
 
INSERT INTO promo (id_promo, nama_promo, id_barang, jenis_diskon, nilai_diskon, tgl_mulai, tgl_selesai, is_aktif) VALUES
('PG0001','Diskon Minyak Goreng','BG000002','persen',8.00,'2026-06-01','2026-06-30','Ya'),
('PG0002','Hemat Susu UHT','BG000007','nominal',1500.00,'2026-06-05','2026-06-25','Ya');
 
INSERT INTO metode_pembayaran (id_metode, nama_metode, keterangan) VALUES
('MR01','tunai','Pembayaran cash'),
('MR02','debit','Kartu debit via EDC'),
('MR03','qris','Scan QRIS'),
('MR04','transfer','Transfer bank'),
('MR05','tarik_tunai','Tarik tunai via EDC (cashback)');
...
('TR001','CR0001','PR0002','2026-06-15 09:30:00',89500,1560,87940,'selesai'),
('TR002',NULL,'PR0006','2026-06-15 14:00:00',16500,1500,15000,'selesai');
 
INSERT INTO detail_transaksi (id_transaksi, id_barang, id_promo, jumlah, harga_satuan, diskon, subtotal) VALUES
(1,'BG000001',NULL,1,65000,0,65000),
(1,'BG000002','PG0001',1,19500,1560,17940),
(1,'BG000003',NULL,1,5000,0,5000),
(2,'BG000007','PG0002',1,16500,1500,15000);
 
INSERT INTO pembayaran (id_transaksi, id_metode, jumlah_bayar, no_referensi, tgl_bayar) VALUES
(1,'MR02',87940,'EDC-TR001-000456','2026-06-15 09:31:00'),
(2,'MR01',15000,NULL,'2026-06-15 14:01:00');

SELECT * FROM toko;
SELECT * FROM divisi;
SELECT * FROM pegawai;
SELECT * FROM pegawai_divisi;
SELECT * FROM absensi;
SELECT * FROM kategori_barang;
SELECT * FROM supplier;
SELECT * FROM barang;
SELECT * FROM harga_barang;
SELECT * FROM display_barang;
SELECT * FROM stok_toko;
SELECT * FROM jadwal_restock;
